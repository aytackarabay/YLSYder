...
def Tweet_Poster(Program_control_path, Tweets_tags_path, list_of_media):
    ...
    while True:
        ...
        utils.Tweet_Manager(api, list_of_media, Tweets, Focus_tags, range(len(Tweets)))
        
        ###Tweet for iktidar tags###
        utils.Tweet_Manager(api, list_of_media, Tweets, Iktidar_tags, range(len(Tweets)))
        
        ###Tweet for muhalefet tags###
        utils.Tweet_Manager(api, list_of_media, Tweets, Muhalefet_tags, Muhalefet_frequencies)

        ###Tweet for gazeteci tags###
        utils.Tweet_Manager(api, list_of_media, Tweets, Gazeteci_tags, Gazeteci_frequencies)

        ###Tweet for diger tags###
        utils.Tweet_Manager(api, list_of_media, Tweets, Diger_tags, Diger_frequencies)